...
class SliderfolderOneItemWidget extends StatelessWidget {
  SliderfolderOneItemWidget(this.sliderfolderOneItemModelObj,
      {this.onTapImgFolderOne});

  SliderfolderOneItemModel sliderfolderOneItemModelObj;

  var controller = Get.find<ProjectsController>();

  VoidCallback? onTapImgFolderOne;
