...
class ListlinkFourItemWidget extends StatelessWidget {
  ListlinkFourItemWidget(this.listlinkFourItemModelObj);

  ListlinkFourItemModel listlinkFourItemModelObj;
