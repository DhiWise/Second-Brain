import '../../core/constants/dashboardConstant.dart';
...
class DashboadinsertScreen extends GetWidget<DashboadinsertController> {
                ...
                child: SingleChildScrollView(
                    child: Container(
                      ...
                      CustomTextFormField(
                          width: 396,
                          focusNode: FocusNode(),
                          controller: controller.inputFieldController4,
                      ...
                      CustomTextFormField(
                          width: 396,
                          focusNode: FocusNode(),
                          controller: controller.inputFieldController5,
  ...
  void onTapBtnLogin2() {
      page.PostPagesReq postPagesReq = page.PostPagesReq(
        parent: page.Parent(
          databaseId: DashboardConstant.database,
        ),
        properties: page.Properties(
          task: page.Task(
            richText: [
              page.RichText(
                text: page.Text(
                  content: controller.inputFieldController4.text,
                ),
              )
            ],
          ),
          date: page.Date(
            richText: [
              page.RichText(
                text: page.Text(
                  content: controller.inputFieldController5.text,
                ),
              )
            ],
          ),
